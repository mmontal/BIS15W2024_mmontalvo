...
R is a software used to program and code and RStudio is like an add on, called a GUI, that is used with R to make it more organized and easier to use. GitHub is a website that is used for programmers to be able to create codes, share them and store them. 
